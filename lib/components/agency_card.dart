...
class _AgencyCardState extends State<AgencyCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
            ...
            boxShadow: [
              BoxShadow(
                color: Colors.black.withValues(
                  alpha: widget.isExpanded ? 0.08 : 0.04,
                ),
                            ...
                            children: [
                              Text(
                                ...
                                style: Theme.of(context).textTheme.titleLarge
                                    ?.copyWith(fontSize: Responsive.fs(16)),
                              ),
                        ...
                        child: Column(
                          children: [
                            ...
                            StreamBuilder<List<GAB>>(
                              stream: firebaseService.getGabs(widget.agency.id),
                              builder: (context, gabSnapshot) {
                                final gabs = gabSnapshot.data ?? [];
                                final okGabs =
                                    gabs
                                        .where((g) => g.statut == 'online')
                                        .length;
                                    ...
                                    return Column(
                                      children: [
                                        ...
                                        _DetailedInfoRow(
                                          ...
                                          statusText:
                                              "$okGabs sur ${gabs.length} fonctionnels",
                                          color:
                                              okGabs == gabs.length
                                                  ? AppColors.statusOk
                                        ...
                                        _DetailedInfoRow(
                                          ...
                                          subtitle:
                                              AppStrings.guichetDescription,
                                          statusText:
                                              "$openGuichets sur ${guichets.length} fonctionnels",
                                          color:
                                              openGuichets > 0
                                                  ? AppColors.statusOk
        ...
        .moveY(begin: 12, end: 0, duration: 600.ms, curve: Curves.easeOutBack);
  }
}
